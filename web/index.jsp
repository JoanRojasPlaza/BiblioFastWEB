 <%-- 
    Document   : index
    Created on : 03-06-2020, 22:20:29
    Author     : joanr
--%>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <ul class="collapsible popout">
                            <li>
                              <div class="collapsible-header teal"><i class="material-icons">import_contacts</i>LIBROS</div>
                              <div class="collapsible-body">
                                  <div class="row">
                                    <div class="col s12">
                                      <ul class="tabs">
                                        <li class="tab col s6"><a href="#test1" class="active" >GESTION DE LIBROS</a></li>
                                        <li class="tab col s6"><a href="#test2">GESTION DE DETALLES</a></li>                                        
                                      </ul>
                                    </div>
                                    <div id="test1" class="col s6">
                                        <h6>Si deseas registrar libros, modificar el ISBN, buscar libro por ISBN, mostrar todos los libros o eliminar algun libro </h6>
                                        <br>
                                        <div class="row">
                                            <div class="col s4">
                                            ...
                                            <div class="col s4">
                                                <a href="libros.jsp" class="btn tooltipped btn-floating pulse" data-position="bottom" data-tooltip=" Haz click aqui"><i class=" large material-icons">login</i></a>
                                            </div>
                                            <div class="col s4">
                                      ...
                                      <div id="test2" class="col s6">
                                          <h6>Para agregar o modificar detalles de los libros de esta biblioteca </h6>
                                        <br>
                                        <div class="row">
                                            <div class="col s4">
                                            ...
                                            <div class="col s4">
                                                <a href="detalles.jsp" class="btn tooltipped btn-floating pulse" data-position="bottom" data-tooltip=" Haz click aqui"><i class=" large material-icons">login</i></a>
                                            </div>
                                            <div class="col s4">
