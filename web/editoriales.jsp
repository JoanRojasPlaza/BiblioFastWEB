<%-- 
    ...
    Created on : 20-06-2020, 20:18:22
    Author     : Joan
--%>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <ul class="collapsible popout">
                            <li>
                                <div class="collapsible-header"><i class="material-icons">queue</i>Registrar editorial</div>
                                            ...
                                            <div class="col s12">
                                                ...
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input type="text" name="nombreEditorial" class="validate" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="collapsible-header"><i class="material-icons">settings</i>Modificar editorial</div>
                                <div class="collapsible-body">
                                    <div class="row">
                                        <div class="col s12">
                            ...
                            <li>
                                <div class="collapsible-header"><i class="material-icons">visibility</i>Mostrar todas las editoriales</div>
                                <div class="collapsible-body">
                                    <div class="row">
                                        <div class="col s12">
                                            <table>
                            ...
                            <li>
                                <div class="collapsible-header"><i class="material-icons">search</i>Buscar editorial</div>
                                <div class="collapsible-body">
                                    <form class="col s8 offset-s3" action="#" method="post">
                                        <div class="row">
                                            <br>
                            ...
                            <li>
                                <div class="collapsible-header"><i class="material-icons">delete</i>Eliminar editorial</div>
                                <div class="collapsible-body">
                                    <form class="col s8 offset-s3" action="#" method="post">
                                        <div class="row">
                                            <br>
