<%-- 
    Document   : compras
    Created on : 14-06-2020, 19:10:23
    Author     : Joan
--%>
            ...
            <div class="col s8">
                <div class="card">
                    <div class="card-image">
                        <img src="Imágenes/Menu Compras.png">
                        <br>
                        <span class="card-title black-text" style="width: 100%; text-align: center"><b>Gestion de compras</b></span>
                    </div>
                    <ul class="collapsible popout">
                        ...
                        <li>
                            <div class="collapsible-header green lighten-3"><i class="material-icons">add_circle</i>Generar nueva compra</div>
                            <div class="collapsible-body">
                                <div class="row">
                                    <form class="col s12">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                ...
                                                <label for="libros">Distribuidor</label>
                                            </div>
                                        </div>
                                        <br>
                                        <a class="waves-effect waves-light btn-small green col s4 offset-s4"><b>Generar compra</b></a>
                                    </form>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="collapsible-header yellow lighten-3"><i class="material-icons">edit</i>Modificar compras</div>
                            <div class="collapsible-body">
                                <div class="row">
                                    <div class="col s12">
                                        <span>Puedes buscar una compra por medio del folio que puedes ingresar a continuación, para así realizar modificaciones en él. O bien, hacer click en el botón de "Modificar" en una compra existente mostrado en la tabla.</span>
                                        <form class="col s8 offset-s3">
                                            <div class="row">
                                                <br>
                                                <div class="input-field col s6">
                                            ...
                                            <div class="col s12">
                                                <table class="bordered highlight">
                                                    <tr>
                                                        ...
                                                        <td width="100px" style="text-align: center"><b>Distribuidor involucrado</b></td>
                                                        ...
                                                        <td width="100px" style="text-align: center"><b>Hora</b></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100px" style="text-align: center">Distribuidor1</td>
                                                        ...
                                                        <td width="100px" style="text-align: center">18:34</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100px" style="text-align: center">"LibroX"</td>
                                                        <td width="100px" style="text-align: center">Distribuidor2</td>
                                                        <td width="100px" style="text-align: center">$34.390</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100px" style="text-align: center">"LibroX"</td>
                                                        <td width="100px" style="text-align: center">Distribuidor3</td>
                                                        <td width="100px" style="text-align: center">$34.390</td>
                        ...
                        <li>
                            <div class="collapsible-header red lighten-2"><i class="material-icons">error</i>Anular compras</div>
                            <div class="collapsible-body">
                                <div class="row">
                                    <div class="col s12">
                                        <span>Puedes buscar una compra por medio del folio que puedes ingresar a continuación, para luego confirmar la anulación. O bien, hacer click en el botón de "Anular" en una compra existente mostrado en la tabla.</span>
                                        <form class="col s8 offset-s3">
                                            <div class="row">
                                                <br>
                                                <div class="input-field col s6">
